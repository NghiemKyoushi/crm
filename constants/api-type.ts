...
export const API_TYPE_CONST = {
  ...
  AUTION_BLOCK: `${FEATURE}/admin/auction/vip-customers/{userId}/block`,
  AUTION_SETTINGS: `${FEATURE}/admin/auction/settings`,
  AUTION_CREATE_ORDER: `${FEATURE}/admin/auction/create-order/{id}`,
  AUTION_BOM: `${FEATURE}/admin/auction/bid/{bidId}/bom`,
} as const;
