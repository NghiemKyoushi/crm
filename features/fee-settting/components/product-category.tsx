...
import { useCreateNewProductType, useListProductType, useUpdateProductType } from "../hooks/fee-setting";
import { CategoryItem } from "@/types/fee-setting";
import { faBaby, faCouch, faFlask, faGamepad, faGolfBallTee, faLaptop, faShoePrints, faShoppingBag, faTshirt, faUtensils } from "@fortawesome/free-solid-svg-icons";
...
const ProductTypeTable: React.FC = () => {
    ...
    const columns: ColumnsType<CategoryItem> = [
        { title: 'Ten loai san pham', width: 220, dataIndex: "name", key: "name" },
        { title: "description", width: 220, dataIndex: "description", key: "description" },
