...
const CheckComingView: React.FC = () => {
    ...
    const [printMode, setPrintMode] = useState<"full" | "package_only">("full");
    ...
    const handlePrint = async (packageInfo: PackageInfo) => {
        ...
        if (packageInfo.id) {
            try {
                ...
                setScanHistory(prev => prev.map(item => item.id === packageInfo.id ? {
                    ...item,
                    printCount: (item.printCount ?? 0) + 1
                } : item));
    ...
    const handlePrintPackageCodeOnly = async (packageInfo: PackageInfo) => {
        setLastPrintedPackage(packageInfo);
        setPrintMode("package_only");
            ...
            <div className="max-w-7xl mx-auto">
                    ...
                    <Row gutter={16}>
                        ...
                        <Col xs={24} lg={12}>
                            <Space direction="vertical" style={{width: "100%"}} size="large">
                                ...
                                <div
                                    className="text-center p-6 bg-gradient-to-r from-blue-500 to-indigo-600 rounded-lg">
                                    <Text className="text-white opacity-90 block mb-2"
                                    ...
                                    <div className="flex items-center justify-center gap-3">
                                        ...
                                        <Button
                                            type="text"
                                            icon={<PrinterOutlined style={{color: "white", fontSize: 20}}/>}
                                            onClick={() => {
                                                if (packageCode) {
                                                    handlePrintPackageCodeOnly({
                                                        id: 0,
                ...
                <div className="border border-gray-200 rounded-lg p-4">
                    <div className="flex items-center gap-2 mb-4">
                        ...
                        <span className="text-sm font-semibold text-gray-800">Lịch Sử Quét</span>
                        ...
                        columns={[
                                ...
                                render: (date: string) => {
                                    ...
                                    return (
                                        <Space direction="vertical" size={1}>
                                            ...
                                            <Text type="secondary" style={{fontSize: 10}}>{timeStr}</Text>
                                        </Space>
                                    );
                                },
                            },
                            {
                                ...
                                render: (_: any, record: PackageInfo) => {
                                    ...
                                    if (orders.length === 0) {
                                        return <Text type="secondary" style={{fontSize: 10}}>Không có đơn</Text>;
                                    }
                                    ...
                                    return (
                                        <Space direction="vertical" size={1} align="center" style={{width: "100%"}}>
                                            <Space size={4}>
                                                {completedCount > 0 && (
                                                    <Badge
                                    ...
                                    return (
                                        <Space size={4} wrap>
                                            {(record.printCount ?? 0) > 0 && (
                                                <Text type="secondary"
                                                      style={{fontSize: 10}}>({record.printCount})</Text>
                                            )}
                                            <Button
                                                type="primary"
                                                size="small"
                                ...
                                render: (_: any, record: OrderInfo) => (
                                    <Space direction="vertical" size={4} style={{width: "100%"}}>
                                        <div style={{display: "flex", gap: 8, alignItems: "center", flexWrap: "wrap"}}>
                                            ...
                                            {record.product_link ? (
                                                <a href={record.product_link} target="_blank" rel="noopener noreferrer"
                                                   style={{fontSize: 11}}>
                                        ...
                                        <div style={{display: "flex", gap: 8, alignItems: "flex-start"}}>
                                            ...
                                            <Text style={{fontSize: 11, flex: 1}}
                                                  ellipsis={{tooltip: record.customer_note}}>
                                        ...
                                        <div style={{display: "flex", gap: 8, alignItems: "flex-start"}}>
                                            ...
                                            <Text style={{fontSize: 11, flex: 1}}
                                                  ellipsis={{tooltip: record.admin_note}}>
                                                {record.admin_note || "-"}
                                            </Text>
                                        </div>
                                    </Space>
                ...
                {/* Hidden Print Label */}
                {lastPrintedPackage && <PrintLabel packageInfo={lastPrintedPackage} printMode={printMode}/>}
