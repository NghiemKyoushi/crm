...
import { Modal, Button, Divider, Checkbox, Collapse, Tag } from "antd";
import { useDetailOrder, useListService } from "../../hooks/orderhub";
import ProductImageSlider from "../product-slider";
...
export interface Product {
  ...
  map_data: {
    url: string;
    price: string; // vì API trả về string
    images: string[];
    description: string;
    productName: string;
  };
