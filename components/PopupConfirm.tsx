...
type ConfirmType = "reset" | "lock" | "delete" | "default";
    ...
    >
      <div className="flex flex-col items-center gap-3 text-center">
        ...
        <div className="flex gap-3 mt-4 w-full justify-center">
          ...
          <button
            className={`min-w-[100px] px-5 py-2.5 rounded-md font-medium transition !text-white ${config[type]?.confirmBtn || config["default"].confirmBtn}`}
            onClick={onConfirm}
            disabled={loading}
          >
